  ...
  return (
    <>
      <div className="fotter">
        <div className="preFotter1">
          <div>
            {repeatIcon}
            <p>
              <b>Hassle-free replacement</b>
              <div>10-day easy replacement policy on mi.com</div>
            </p>
          </div>
          <div>
            {shieldIcon}
            <p>
              ...
              <p>We support cards. Wallets, EMI ans COD</p>
            </p>
          </div>
          <div>
            {mapIcon}
            <p>
              ...
              <p>1000 Mi service-center across 600 cities</p>
            </p>
          </div>
        </div>
        <div className="preFotter2">
          <div>
            <h4>
              LET'S STAY IN TOUCH{" "}
          ...
          <div>
            ...
            <div>Thanks. You're on our email list for special offer</div>
          </div>
          <div>
            <h4>
              FOLLOW MI<div>We want to hear from you!</div>
            </h4>
          </div>
          <div>
            <p>
